...
1. Required arguments:
   - --loom-file : Path to the output of velocyto in .loom format
   - -wd : Path to the folder with counts, gene names, and metadata in Scanpy Anndata format
...
3. Optional arguments:
   - **Input files**
     - --counts-file : Name of the file with counts, default = 'counts.mtx'
   ...
   - **Output file**
     - --output-file : Nname of the output file, default = "splice\_aware\_matrix.csv"
   - **Analysis parameters**
